...
### **Hooks** 
- way for one piece of code to interact/modify another piece of code at specific, pre-defined spots. <br> 
...
| Change data                   | **Filter** |
| Output HTML                   | Action     |
| Modify return value           | Filter     |
| Let others extend your plugin | Both       |
